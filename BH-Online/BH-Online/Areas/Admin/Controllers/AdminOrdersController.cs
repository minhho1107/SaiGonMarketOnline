...
namespace BH_Online.Areas.Admin.Controllers
{
    ...
    public class AdminOrdersController : Controller
    {
        ...
        public AdminOrdersController(BHOnlineContext context)
        {
            _context = context;
        }
        ...
        {
            var bHOnlineContext = _context.Orders.Include(o => o.Customer).Include(o => o.TransactStatus);
            return View(await bHOnlineContext.ToListAsync());
        }
